...
| ------------------------------ | ----------------------------------------------------------- | ------------------------ |
| **Fireweb**                    | JSON-based Firestore management tool for developers         | Vue, Go, Firestore       |
| **Sky**                        | Secure cloud file storage with OAuth integration            | Go, MongoDB, GCP         |
| **Atlas**                      | AI/NLP assistant similar to ChatGPT with subscription model | Python, Go, FastAPI      |
| **Dialogflow CX Integrations** | WhatsApp & Cloud Run chatbot systems for enterprises        | Go, GCP, Aldeamo, Apigee |
...
> *“I build systems that make data, AI, and automation feel human.”*
