...
export class NavigatorComponent implements OnInit {
  navLinks = [
    { displayName: 'Portafolio', url: '/portfolio' },
    { displayName: 'Mis habilidades', url: '/about' },
    { displayName: 'Mi perfil', url: '/profiles' },
    { displayName: 'Tarjeta profesional', url: '/profile-card' }
  ];
